...
spell_element_ring_and_tags = {
  'Biting Steel' => { element: 'Ogień', ring: '1', tags: ['Rzemiosło']} },
  'Burning Kiss of Steel' => { element: 'Ogień', ring: '1', tags: ['Bitwa']} },
  'Envious Flames' => { element: 'Ogień', ring: '1'} },
  'Extinguish' => { element: 'Ogień', ring: '1'} },
  'Fires of Purity' => { element: 'Ogień', ring: '1', tags: ['Obrona']} },
  'The Fires That Cleanse' => { element: 'Ogień', ring: '1'} },
  'Fury of Osano-Wo' => { element: 'Ogień', ring: '1', tags: ['Grom']} },
  'Katana of Fire' => { element: 'Ogień', ring: '1', tags: ['Bitwa', 'Rzemiosło']} },
  'Never Alone' => { element: 'Ogień', ring: '1'} },
  'The Raging Forge' => { element: 'Ogień', ring: '1', tags: ['Rzemiosło'] },
  'Disrupt the Aura' => { element: 'Ogień', ring: '2'} },
  'Enticing the Dance of Flame' => { element: 'Ogień', ring: '2'} },
  'The Fires From Within' => { element: 'Ogień', ring: '2'} },
  'Hurried Steps' => { element: 'Ogień', ring: '2' },
  'Mental Quickness' => { element: 'Ogień', ring: '2' },
  'Relentless Heat' => { element: 'Ogień', ring: '2', tags: ['Obrona'] },
  'Tail of the Fire Dragon' => { element: 'Ogień', ring: '2' },
  'Ward of Purity' => { element: 'Ogień', ring: '2', tags: ['Pieczęć'] },
  'Breath of the Fire Dragon' => { element: 'Ogień', ring: '3' },
  'Fiery Wrath' => { element: 'Ogień', ring: '3' },
  'The Fist of Osano-Wo' => { element: 'Ogień', ring: '3', tags: ['Grom'] },
  'Haze of Battle' => { element: 'Ogień', ring: '3', tags: ['Bitwa'] },
  'Hungry Blade' => { element: 'Ogień', ring: '3', tags: ['Rzemiosło'] },
  'Ravenous Swarms' => { element: 'Ogień', ring: '3' },
  'Shining Light' => { element: 'Ogień', ring: '3', tags: ['Obrona'] },
  'Death of Flame' => { element: 'Ogień', ring: '4' },
  'Defense of the Firestorm' => { element: 'Ogień', ring: '4', tags: ['Obrona'] },
  'The Mending Forge' => { element: 'Ogień', ring: '4', tags: ['Rzemiosło'] },
  'Symbol of Fire' => { element: 'Ogień', ring: '4', tags: ['Pieczęć'] },
  'Wall of Fire' => { element: 'Ogień', ring: '4' },
  'Ward of Thunder' => { element: 'Ogień', ring: '4', tags: ['Obrona', 'Pieczęć', 'Grom'] },
  'Destructive Wave' => { element: 'Ogień', ring: '5' },
  'Everburning Rage' => { element: 'Ogień', ring: '5' },
  'Follow the Flame' => { element: 'Ogień', ring: '5' },
  'Light of the Sun' => { element: 'Ogień', ring: '5', tags: ['Jadeit']} },
  'Wings of the Phoenix' => { element: 'Ogień', ring: '5', tags: ['Podróż']} },
  'Beam of the Inferno' => { element: 'Ogień', ring: '6'} },
  'Globe of the Everlasting Sun' => { element: 'Ogień', ring: '6', tags: ['Obrona']} },
  'The Soul`s Blade' => { element: 'Ogień', ring: '6', tags: ['Rzemiosło'] },
  'Arrow`s Flight' => { element: 'Powietrze', ring: '1', tags: ['Bitwa'] },
  'Blessed Wind' => { element: 'Powietrze', ring: '1', tags: ['Obrona'] },
  'By the Light of the Moon' => { element: 'Powietrze', ring: '1' },
  'Cloak of Night' => { element: 'Powietrze', ring: '1', tags: ['Iluzja'] },
  'Gathering Swirl' => { element: 'Powietrze', ring: '1' },
  'Legacy of Kaze-no-Kami' => { element: 'Powietrze', ring: '1', tags: ['Rzemiosło'] },
  'Nature`s Touch' => { element: 'Powietrze', ring: '1' },
  'Tempest of Air' => { element: 'Powietrze', ring: '1', tags: ['Grom'] },
  'Token of Memory' => { element: 'Powietrze', ring: '1', tags: ['Rzemiosło', 'Iluzja'] },
  'To Seek the Truth' => { element: 'Powietrze', ring: '1' },
  'Voice of the Wind' => { element: 'Powietrze', ring: '1' },
  'Way of Deception' => { element: 'Powietrze', ring: '1', tags: ['Iluzja'] },
  'Yari of Air' => { element: 'Powietrze', ring: '1', tags: ['Rzemiosło', 'Grom'] },
  'Benten`s Touch' => { element: 'Powietrze', ring: '2' },
  'Call Upon the Wind' => { element: 'Powietrze', ring: '2', tags: ['Podróż'] },
  'Elemental Cipher' => { element: 'Powietrze', ring: '2', tags: ['Iluzja'] },
  'Flight of Doves' => { element: 'Powietrze', ring: '2', tags: ['Iluzja'] },
  'Freedom of the Air' => { element: 'Powietrze', ring: '2', tags: ['Pieczęć'] },
  'Hidden Visage' => { element: 'Powietrze', ring: '2', tags: ['Iluzja'] },
  'The Kami`s Whisper' => { element: 'Powietrze', ring: '2', tags: ['Iluzja'] },
  'Mists of Illusion' => { element: 'Powietrze', ring: '2', tags: ['Rzemiosło', 'Iluzja'] },
  'Quiescence of Air' => { element: 'Powietrze', ring: '2', tags: ['Pieczęć'] },
  'Request to Hato-no-Kami' => { element: 'Powietrze', ring: '2', tags: ['Podróż'] },
  'Secrets on the Wind' => { element: 'Powietrze', ring: '2' },
  'Whispering Wind' => { element: 'Powietrze', ring: '2', tags: ['Przepowiednie'] },
  'Wind-Born Slumbers' => { element: 'Powietrze', ring: '2' },
  'Wolf`s Proposal' => { element: 'Powietrze', ring: '2', tags: ['Iluzja'] },
  'Air Kami`s Blessing' => { element: 'Powietrze', ring: '3' },
  'Essence of Air' => { element: 'Powietrze', ring: '3', tags: ['Obrona'] },
  'The Eye Shall Not See' => { element: 'Powietrze', ring: '3', tags: ['Obrona'] },
  'Garbled Tongue' => { element: 'Powietrze', ring: '3', tags: ['Iluzja'] },
  'Mask of Wind' => { element: 'Powietrze', ring: '3', tags: ['Iluzja'] },
  'Soul of Kaze-no-Kami' => { element: 'Powietrze', ring: '3' },
  'Striking the Storm' => { element: 'Powietrze', ring: '3', tags: ['Obrona'] },
  'Summoning the Gale' => { element: 'Powietrze', ring: '3', tags: ['Obrona'] },
  'Summon Fog' => { element: 'Powietrze', ring: '3' },
  'Touch of Air`s Grace' => { element: 'Powietrze', ring: '3', tags: ['Iluzja'] },
  'Your Heart`s Enemy' => { element: 'Powietrze', ring: '3', tags: ['Iluzja'] },
  'Call the Spirit' => { element: 'Powietrze', ring: '4' },
  'Castle of Air' => { element: 'Powietrze', ring: '4', tags: ['Obrona', 'Iluzja']} },
  'False Realm' => { element: 'Powietrze', ring: '4', tags: ['Bitwa', 'Iluzja']} },
  'Funeral Rites' => { element: 'Powietrze', ring: '4'} },
  'Gift of Wind' => { element: 'Powietrze', ring: '4', tags: ['Iluzja']}, },
  'Howl of Isora' => { element: 'Powietrze', ring: '4', tags: ['Grom']} },
  'Know the Mind' => { element: 'Powietrze', ring: '4'} },
  'Look into the Soul' => { element: 'Powietrze', ring: '4', tags: ['Przepowiednie'] },
  'Netsuke of Wind' => { element: 'Powietrze', ring: '4', tags: ['Rzemiosło', 'Iluzja'] },
  'Seeking the Way' => { element: 'Powietrze', ring: '4', tags: ['Iluzja'] },
  'Symbol of Air' => { element: 'Powietrze', ring: '4', tags: ['Pieczęć'] },
  'Tenjin`s Ear' => { element: 'Powietrze', ring: '4', tags: ['Podróż'] },
  'Whispers of the Forgotten' => { element: 'Powietrze', ring: '4' },
  'Wisdom of the Kami' => { element: 'Powietrze', ring: '4' },
  'Cloud the Mind' => { element: 'Powietrze', ring: '5' },
  'Defender From Beyond' => { element: 'Powietrze', ring: '5', tags: ['Bitwa'] },
  'Draw Back the Shadow' => { element: 'Powietrze', ring: '5' },
  'Echoes on the Breeze' => { element: 'Powietrze', ring: '5' },
  'Facing Your Devils' => { element: 'Powietrze', ring: '5' },
  'Legion of the Moon' => { element: 'Powietrze', ring: '5', tags: ['Iluzja'] },
  'Slayer`s Knives' => { element: 'Powietrze', ring: '5', tags: ['Grom'] },
  'Rise, Air' => { element: 'Powietrze', ring: '6' },
  'The False Legion' => { element: 'Powietrze', ring: '6', tags: ['Bitwa', 'Iluzja'] },
  'Piercing the Heavens' => { element: 'Powietrze', ring: '6' },
  'Wind of the Moon' => { element: 'Powietrze', ring: '6' },
  'Wrath of Kaze-no-Kami (Hurricane)' => { element: 'Powietrze', ring: '6', tags: ['Grom'] },
  'Bo of Water' => { element: 'Woda', ring: '1', tags: ['Rzemiosło'] },
  'Clarity of Purpose' => { element: 'Woda', ring: '1', tags: ['Bitwa'] },
  'Ebbing Strength' => { element: 'Woda', ring: '1', tags: ['Obrona'] },
  'Path to Inner Peace' => { element: 'Woda', ring: '1' },
  'Reflections of Pan Ku' => { element: 'Woda', ring: '1', tags: ['Przepowiednie'] },
  'Reversal of Fortunes' => { element: 'Woda', ring: '1' },
  'The Rushing Wave' => { element: 'Woda', ring: '1', tags: ['Podróż'] },
  'Speed of the Waterfall' => { element: 'Woda', ring: '1', tags: ['Podróż'] },
  'Spirit of the Water' => { element: 'Woda', ring: '1', tags: ['Bitwa'] },
  'Sympathetic Energies' => { element: 'Woda', ring: '1' },
  'Cloak of the Miya' => { element: 'Woda', ring: '2', tags: ['Obrona'] },
  'Inari`s Blessing' => { element: 'Woda', ring: '2', tags: ['Rzemiosło'] },
  'Reflective Pool' => { element: 'Woda', ring: '2', tags: ['Przepowiednie'] },
  'Rejuvenating Vapors' => { element: 'Woda', ring: '2' },
  'Stand Against the Waves' => { element: 'Woda', ring: '2', tags: ['Bitwa'] },
  'The Ties That Bind' => { element: 'Woda', ring: '2', tags: ['Przepowiednie'] },
  'Wave-Borne Speed' => { element: 'Woda', ring: '2', tags: ['Podróż'] },
  'Wisdom & Clarity' => { element: 'Woda', ring: '2' },
  'Near to Ice' => { element: 'Woda', ring: '3' },
  'Regrow the Wound' => { element: 'Woda', ring: '3' },
  'Silent Waters' => { element: 'Woda', ring: '3', tags: ['Obrona'] },
  'Strike of the Tsunami' => { element: 'Woda', ring: '3' },
  'Visions of the Future' => { element: 'Woda', ring: '3', tags: ['Przepowiednie'] },
  'Walking Upon the Waves' => { element: 'Woda', ring: '3', tags: ['Podróż'] },
  'Water Kami`s Blessing' => { element: 'Woda', ring: '3' },
  'Dominion of Suitengu' => { element: 'Woda', ring: '4', tags: ['Przepowiednie'] },
  'Ebb & Flow of Battle' => { element: 'Woda', ring: '4', tags: ['Bitwa'] },
  'Heart of the Water Dragon' => { element: 'Woda', ring: '4' },
  'The Path Not Taken' => { element: 'Woda', ring: '4' },
  'Strike of the Flowing Waters' => { element: 'Woda', ring: '4' },
  'Symbol of Water' => { element: 'Woda', ring: '4', tags: ['Pieczęć'] },
  'Ever-Changing Waves' => { element: 'Woda', ring: '5', tags: ['Iluzja'] },
  'The Final Bond' => { element: 'Woda', ring: '5', tags: ['Przepowiednie'] },
  'Hands of the Tides' => { element: 'Woda', ring: '5', tags: ['Bitwa', 'Podróż'] },
  'Power of the Ocean' => { element: 'Woda', ring: '5', tags: ['Obrona'] },
  'Suitengu`s Embrace' => { element: 'Woda', ring: '5', tags: ['Grom'] },
  'Peace of the Kami' => { element: 'Woda', ring: '6' },
  'Rise, Water' => { element: 'Woda', ring: '6' },
  'Water`s Sweet Clarity' => { element: 'Woda', ring: '6', tags: ['Przepowiednie'] },
  'Armor of Earth' => { element: 'Ziemia', ring: '1', tags: ['Bitwa', 'Obrona'] },
  'Courage of the Seven Thunders' => { element: 'Ziemia', ring: '1', tags: ['Bitwa'] },
  'Earth`s Stagnation' => { element: 'Ziemia', ring: '1' },
  'Earth`s Touch' => { element: 'Ziemia', ring: '1', tags: ['Obrona'] },
  'Elemental Ward' => { element: 'Ziemia', ring: '1', tags: ['Pieczęć'] },
  'Jade Strike' => { element: 'Ziemia', ring: '1', tags: ['Jadeit','Grom'] },
  'Jurojin`s Balm' => { element: 'Ziemia', ring: '1' },
  'Minor Binding' => { element: 'Ziemia', ring: '1' },
  'Soul of Stone' => { element: 'Ziemia', ring: '1', tags: ['Obrona'] },
  'Tetsubo of Earth' => { element: 'Ziemia', ring: '1', tags: ['Rzemiosło', 'Jadeit'] },
  'Be the Mountain' => { element: 'Ziemia', ring: '2', tags: ['Obrona'] },
  'Earth Becomes Sky' => { element: 'Ziemia', ring: '2', tags: ['Jadeit', 'Grom'] },
  'Embrace of Kenro-Ji-Jin' => { element: 'Ziemia', ring: '2', tags: ['Podróż'] },
  'Force of Will' => { element: 'Ziemia', ring: '2', tags: ['Bitwa'] },
  'Grasp of Earth' => { element: 'Ziemia', ring: '2' },
  'Hands of Clay' => { element: 'Ziemia', ring: '2', tags: ['Podróż'] },
  'The Mountain`s Feet' => { element: 'Ziemia', ring: '2', tags: ['Obrona']} },
  'Wholeness of the World' => { element: 'Ziemia', ring: '2', tags: ['Obrona']} },
  'Bonds of Ningen-Do' => { element: 'Ziemia', ring: '3', tags: ['Pieczęć']} },
  'Earth Kami`s Blessing' => { element: 'Ziemia', ring: '3', tags: ['Bitwa']} },
  'Earth`s Protection' => { element: 'Ziemia', ring: '3'} },
  'Purge the Taint' => { element: 'Ziemia', ring: '3', tags: ['Jadeit']} },
  'Sharing the Strength of Many' => { element: 'Ziemia', ring: '3'} },
  'Strength of the Crow' => { element: 'Ziemia', ring: '3', tags: ['Jadeit']} },
  'The Wolf`s Mercy' => { element: 'Ziemia', ring: '3'} },
  'Armor of the Emperor' => { element: 'Ziemia', ring: '4', tags: ['Obrona']} },
  'Essence of Earth' => { element: 'Ziemia', ring: '4', tags: ['Bitwa']} },
  'Symbol of Earth' => { element: 'Ziemia', ring: '4', tags: ['Pieczęć']} },
  'Tomb of Jade' => { element: 'Ziemia', ring: '4', tags: ['Jadeit']} },
  'Wall of Earth' => { element: 'Ziemia', ring: '4', tags: ['Obrona']} },
  'Earthquake' => { element: 'Ziemia', ring: '5'} },
  'Major Binding' => { element: 'Ziemia', ring: '5', tags: ['Jadeit', 'Pieczęć']} },
  'Strike at the Roots' => { element: 'Ziemia', ring: '5'} },
  'The Kami`s Strength' => { element: 'Ziemia', ring: '5', tags: ['Bitwa']} },
  'The Kami`s Will' => { element: 'Ziemia', ring: '5', tags: ['Obrona']} },
  'Essence of Jade' => { element: 'Ziemia', ring: '6', tags: ['Obrona', 'Jadeit']} },
  'Power of the Earth Dragon' => { element: 'Ziemia', ring: '6', tags: ['Obrona'] },
  'Prison of Earth' => { element: 'Ziemia', ring: '6', tags: ['Pieczęć'] },
  'Rise, Earth' => { element: 'Ziemia', ring: '6' },
  'Boundless Sight' => { element: 'Pustka', ring: '1' },
  'Drawing the Void' => { element: 'Pustka', ring: '1' },
  'Flow Through the Void' => { element: 'Pustka', ring: '1' },
  'See Through Lies' => { element: 'Pustka', ring: '1' },
  'Sense Void' => { element: 'Pustka', ring: '1' },
  'Touch the Emptiness' => { element: 'Pustka', ring: '1' },
  'The Void`s Caress' => { element: 'Pustka', ring: '1' },
  'Witness the Untold' => { element: 'Pustka', ring: '1', tags: ['Przepowiednie'] },
  'Altering the Course' => { element: 'Pustka', ring: '2' },
  'Drink of Your Essence' => { element: 'Pustka', ring: '2' },
  'The Empty Voice' => { element: 'Pustka', ring: '2' },
  'False Whispers' => { element: 'Pustka', ring: '2' },
  'Reach Through the Void' => { element: 'Pustka', ring: '2' },
  'Severed from the Stream' => { element: 'Pustka', ring: '2' },
  'Echoes in the Void' => { element: 'Pustka', ring: '3' },
  'Kharmic Intent' => { element: 'Pustka', ring: '3' },
  'Moment of Clarity' => { element: 'Pustka', ring: '3' },
  'Read the Essence' => { element: 'Pustka', ring: '3', tags: ['Przepowiednie'] },
  'Void Release' => { element: 'Pustka', ring: '3' },
  'Balance of Elements' => { element: 'Pustka', ring: '4' },
  'Draw Closed the Veil' => { element: 'Pustka', ring: '4' },
  'Fill the Emptiness' => { element: 'Pustka', ring: '4' },
  'Void Strike' => { element: 'Pustka', ring: '4' },
  'Divide the Soul' => { element: 'Pustka', ring: '5' },
  'Reforge' => { element: 'Pustka', ring: '5' },
  'Unbound Essence' => { element: 'Pustka', ring: '5' },
  'Ring of the Void' => { element: 'Pustka', ring: '6' },
  'Rise from the Ashes' => { element: 'Pustka', ring: '6' },
  'Unmake the World' => { element: 'Pustka', ring: '6' },
